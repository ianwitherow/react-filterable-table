...
/***/ function(module, exports, __webpack_require__) {
	...
	var FilterableTable = __webpack_require__(3);

	var data = [{ name: "Steve", age: 27, job: "Sandwich Eater" }, { name: "Gary", age: 35, job: "Falafeler" }, { name: "Greg", age: 24, job: "Jelly Bean Juggler" }, { name: "Jeb", age: 39, job: "Burrito Racer" }, { name: "Jeff", age: 48, job: "Hot Dog Wrangler" }, { name: "Steve", age: 27, job: "Sandwich Eater" }, { name: "Gary", age: 35, job: "Falafeler" }, { name: "Greg", age: 24, job: "Jelly Bean Juggler" }, { name: "Jeb", age: 39, job: "Burrito Racer" }, { name: "Jeff", age: 48, job: "Hot Dog Wrangler" }, { name: "Steve", age: 27, job: "Sandwich Eater" }, { name: "Gary", age: 35, job: "Falafeler" }, { name: "Greg", age: 24, job: "Jelly Bean Juggler" }, { name: "Jeb", age: 39, job: "Burrito Racer" }, { name: "Jeff", age: 48, job: "Hot Dog Wrangler" }, { name: "Steve", age: 27, job: "Sandwich Eater" }, { name: "Gary", age: 35, job: "Falafeler" }, { name: "Greg", age: 24, job: "Jelly Bean Juggler" }, { name: "Jeb", age: 39, job: "Burrito Racer" }, { name: "Jeff", age: 48, job: "Hot Dog Wrangler" }, { name: "Steve", age: 27, job: "Sandwich Eater" }, { name: "Gary", age: 35, job: "Falafeler" }, { name: "Greg", age: 24, job: "Jelly Bean Juggler" }, { name: "Jeb", age: 39, job: "Burrito Racer" }, { name: "Jeff", age: 48, job: "Hot Dog Wrangler" }];

	var fields = [{ name: 'name', displayName: "Name", inputFilterable: true, sortable: true }, { name: 'age', displayName: "Age", inputFilterable: true, exactFilterable: true, sortable: true }, { name: 'job', displayName: "Occupation", inputFilterable: true, exactFilterable: true, sortable: true }];

	ReactDOM.render(React.createElement(
		'div',
		null,
		React.createElement(FilterableTable, _defineProperty({
			namespace: 'People',
			initialSort: 'name',
			data: data,
			fields: fields,
	...
	var FilterableTable = function (_React$Component) {
		...
		_createClass(FilterableTable, [{
			...
			value: function render() {
				...
				var serverErrorMessage = !this.state.serverError ? '' : React.createElement(
					'div',
					{ className: 'alert alert-danger text-center' },
					'Something went wrong! Check console for error message(s).'
				);

				var noRecordsMessage = !this.state.serverError && !this.state.loading && this.state.entries.length === 0 ? React.createElement(
					'div',
					null,
				...
				var table = this.state.loading || this.state.entries.length === 0 ? '' : React.createElement(_Table2.default, {
				...
				var topPager = this.state.loading || this.state.entries.length === 0 || this.props.pagersVisible === false ? '' : React.createElement(_reactPager2.default, { total: totalPages,
				...
				var bottomPager = this.state.loading || this.state.entries.length === 0 || this.props.pagersVisible === false ? '' : React.createElement(_reactPager2.default, { total: totalPages,
					current: this.state.page,
					visiblePages: this.state.visiblePages,
					onPageChanged: this.updatePage
				});
			...
			value: function render() {
				...
				var headerCells = fields.map(function (field, i) {
					return React.createElement(
						...
						React.createElement("span", { className: _this2.headerSortClassName(field) })
					);
				});
						...
						return React.createElement(
							...
							React.createElement(
								...
								{ className: spanClassName, onClick: field.exactFilterable ? function () {
										return addExactFilter(record[field.name], field.name, field.displayName || field.name);
									} : null },
								recordBody
							)
						);
				...
				return rows.length === 0 ? React.createElement(
					"p",
					{ className: "well text-center" },
	...
	var Header = function (_React$Component) {
		...
		_createClass(Header, [{
			...
			value: function render() {
				...
				var recordCountMessage = React.createElement(
					"span",
					null,
					recordCount,
					" ",
				...
				return React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								...
								React.createElement("input", { type: "text", className: "form-control filter-input", value: filter, onChange: this.filterChanged, ref: "filter", placeholder: "Filter" }),
								React.createElement(
									"span",
					...
					React.createElement(
						...
						React.createElement(
							"div",
							{ className: "col-sm-8" },
							React.createElement(_ExactFilters2.default, {
		...
		_createClass(ExactFilters, [{
			...
			value: function render() {
				...
				var filters = exactFilters.map(function (filter, i) {
					return React.createElement(ExactFilter, { filter: filter, removeFilter: removeExactFilter, key: i });
				});
